...
class _QuizCustomDialogState extends State<QuizCustomDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration:
          BoxDecoration(borderRadius: BorderRadius.circular(15), color: ice),
      child: Column(
        children: [
  ...
  void _startQuiz() async {
    ...
    try {
      ...
      Navigator.pushReplacement(
          ...
          MaterialPageRoute(
              builder: (_) => ErrorPage(
                    message: "خطأ غير متوقع أثناء محاولة الاتصال",
                  )));
    }
    setState(() {
      processing = false;
