        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                "ميزات",
                style: TextStyle(fontSize: 26.0, fontWeight: FontWeight.bold,color: dark),
              ),
              SlideTransition(
                ...
                child: SlideTransition(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      "دورات قيّمة، تسطيع أن تعيد مشاهدتها بعدد المرات التي تريدها لتحصل على الفائدة الكاملة بأي وقت وبكل مكان",
