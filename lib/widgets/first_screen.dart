              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    width: 200,
                    child: Text(
                      "حاول تعديل الفلتر للعثور على ما تبحث عنه!",
        ...
        child: Column(children: <Widget>[
          ListView.builder(
              ...
              itemBuilder: (context, idx) {
                ...
                return ExpCoursesListItem(
                    filteredCourses[idx],
                    coursePro.isPurchased(filteredCourses[idx].id),
                    mode.txtcolor,filteredCourses[(idx+1<filteredCourses.length?idx+1:idx)]);
              })
        ]),
      ),
    );
