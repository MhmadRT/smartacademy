...
class SuccessTicket extends StatefulWidget {
  SuccessTicket(
      {this.msgResponse, this.purchaseDate, this.time, this.transactionAmount, this.isCOD=false});
  final msgResponse;
  final purchaseDate;final bool isCOD;
  final time;
            ...
            child: Column(
              ...
              children: <Widget>[
                ProfileTile(
                  title: "شكراً لك !",
                  textColor: pink,
                  subtitle: widget.isCOD?'': widget.msgResponse,
                ),
                ListTile(
                  title: Text("التاريخ", style: TextStyle(color: color)),
                  subtitle: Text(
                    widget.purchaseDate,
                ...
                widget.isCOD?ListTile(
                  title:
                      Text("الدفع في مقر الشركة" ,
                      style: TextStyle(color: dark)),
                ):ListTile(
                  title:
                      Text("المبلغ", style: TextStyle(color: dark)),
