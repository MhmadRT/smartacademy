...
class UserProfile with ChangeNotifier {
  ...
  Future<String> fetchUserProfile() async {
    ...
    print(url);
    List<String> auth = authToken.toString().split('-');
    var tttt = {'token': authToken};
    print('start \n ${jsonEncode(tttt)}');
      print('USER FROM API');
      ...
      if (res.statusCode == 200) {
        ...
        http.Response userProfileResponse = await http
            .post(APIData.userProfile + "${APIData.secretKey}", headers: {
          "Accept": "application/json",
          "Authorization": "Bearer $authToken",
        });
        ...
        throw "ERROR\n${url}${res.body}\n${res.statusCode}can't get user profile data";
      }
