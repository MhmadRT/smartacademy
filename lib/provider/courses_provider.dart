...
class CoursesProvider with ChangeNotifier {
  ...
  Progress getAllProgress(int id) {
    Progress pro=Progress(markChapterId: []);
  ...
  Future<CoursesModel> getAllCourse(BuildContext context) async {
    ...
    coursesModel = CoursesModel.fromJson(homeData.mainApi.courses.toJson());
  ...
  Future<MyCoursesModel> initPurchasedCourses(BuildContext context) async {
    ...
    log(res.request.headers['Authorization']);
    debugPrint(res.body);
    ...
    if (res.statusCode == 200) {
      ...
      print('initPurchasedCourses From API');
    } else {
